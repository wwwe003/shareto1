$(function () {
    ...
    $("#article-history").addClass("active")
    $("#article-history a").addClass("active")

    history_Pagination()
})
function history_Pagination(){
    ...
    if (pageCode !== undefined && pageSize !== undefined && totalRecord !== undefined) {
        ...
        if(begin!==end&&end!==0){
            if (pageCode === 1) {
                ...
                $("#pageUL").append("<li class='page-item'><a class='page-link' href='/toshare/admin/history?currentPage=" + 1 + "'>First</a></li>")
                    .append("<li class='page-item'><a class='page-link' href='/toshare/admin/history?currentPage=" + pagePrevious + "'>&lt;Previous</a></li>");
            }
            for (let i = begin; i <= end; i++) {
                if (i === pageCode) {
                    $("#pageUL").append("<li class='page-item active'><span class='page-link' >" + i + "<span class='sr-only'>(current)</span></span></li>")
                } else {
                    $("#pageUL").append("<li class='page-item'><a class='page-link' href='/toshare/admin/history?currentPage=" + i + "'>" + i + "</a></li>");
                }
            }
            if (pageCode === totalPages) {
                ...
                $("#pageUL").append("<li class='page-item'><a class='page-link' href='/toshare/admin/history?currentPage=" + pageNext + "'>Next&gt;</a></li>")
                .append("<li class='page-item'><a class='page-link' href='/toshare/admin/history?currentPage=" + totalPages + "'>Last</a></li>");
            }
        }
    }
}